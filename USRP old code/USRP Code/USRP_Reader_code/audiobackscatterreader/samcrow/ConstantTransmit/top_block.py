...
# Title: Top Block
# Generated: Wed May 10 19:35:34 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.bandwidth = bandwidth = 1000

        ##################################################
        # Blocks
        ##################################################
        self._tx_gain_range = Range(0, 31.5, 0.5, 0, 200)
        self._tx_gain_win = RangeWidget(self._tx_gain_range, self.set_tx_gain, 'Transmit gain', "counter_slider", float)
        self.top_layout.addWidget(self._tx_gain_win)
        self._rx_gain_range = Range(0, 31.5, 0.5, 0, 200)
        self._rx_gain_win = RangeWidget(self._rx_gain_range, self.set_rx_gain, 'Receive gain', "counter_slider", float)
